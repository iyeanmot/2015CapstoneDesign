...
public class show_edu1 : MonoBehaviour {
	...
	void Update () {
        ...
        if (_board.GetComponent<select_edu>().now_edu == this.gameObject)
        {
            ...
            {
                gameObject.SetActive(false);
                _board.GetComponent<select_edu>().now_edu = _board.GetComponent<select_edu>().edu2;
                _board.GetComponent<select_edu>()._state = 0;
                _board.GetComponent<select_edu>().edu1_finished = true;
