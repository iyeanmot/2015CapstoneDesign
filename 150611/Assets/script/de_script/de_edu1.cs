...
public class de_edu1 : MonoBehaviour {
	...
	void Update () {
        ...
        if (_board.GetComponent<de_select_edu>().now_edu == this.gameObject)
        {
            ...
            if (_board.GetComponent<de_select_edu>()._state >= 2)
            {
                ...
                _board.GetComponent<de_select_edu>().now_edu = _board.GetComponent<de_select_edu>().edu2;
                _board.GetComponent<de_select_edu>()._state = 0;
                _board.GetComponent<de_select_edu>().edu1_finished = true;
